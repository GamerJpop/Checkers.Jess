...
function moveSelectedCheckerHere() {
    ...
    if(selectedChecker) {
        ...
        if(selectedChecker.color == `black` && selectedChecker.row == 1) {
            console.log("There is a black checker at the white home")
            selectedChecker.isKing = true;
            
        }
        
        if(selectedChecker.color == `white` && selectedChecker.row == 8) {
            console.log("There is a white checker at the black home")
            selectedChecker.isWhiteKing = true;
